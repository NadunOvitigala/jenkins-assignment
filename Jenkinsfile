    ...
    stages {
        stage ('sonarqube') {
            steps {
                script {
                    sh 'whoami'
                    sh '/opt/sonar-scanner-5.0.1.3006-linux/bin/sonar-scanner -Dsonar.projectKey=jenkins-assignment -Dsonar.host.url=http://localhost:9000 -Dsonar.login=sqp_524d836223a10583b80f2bc2bb83042ff7734a29'
                }
            }
        }
